    ...
    public struct CreateBlog: GraphQLSelectionSet {
      ...
      public struct Post: GraphQLSelectionSet {
        ...
        public struct Item: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, title: String, blogId: GraphQLID) {
            self.init(snapshot: ["__typename": "Post", "id": id, "title": title, "blogID": blogId])
          }
...
public final class CreatePostMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreatePost: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, title: String, blogId: GraphQLID, blog: Blog? = nil, comments: Comment? = nil) {
        self.init(snapshot: ["__typename": "Post", "id": id, "title": title, "blogID": blogId, "blog": blog.flatMap { $0.snapshot }, "comments": comments.flatMap { $0.snapshot }])
      }
      ...
      public struct Comment: GraphQLSelectionSet {
        ...
        public struct Item: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, postId: GraphQLID, content: String) {
            self.init(snapshot: ["__typename": "Comment", "id": id, "postID": postId, "content": content])
          }
...
public final class CreateCommentMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateComment: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, postId: GraphQLID, post: Post? = nil, content: String) {
        self.init(snapshot: ["__typename": "Comment", "id": id, "postID": postId, "post": post.flatMap { $0.snapshot }, "content": content])
      }
